...
| Plugin `submit` | NeMo Helix secret name in the target workspace, such as `nvidia-api-key` |
...
Create it through the supported secrets CLI for the installed NeMo Helix
